...
export default function FactsDialogPopup({headerTitle, content, factType, setFormField, modalIsOpen, setClosed, actionOnSubmit, isLoading, isError, isSuccess, successMessage}) {
    return (
        <Modal 
            isOpen={modalIsOpen}
                    ...
                    <div className="dialog-content-entry">
                        <div >
                            <div className="dialog-title">{content}</div>
                                <div className="mb-3">
                                    <label htmlFor="exampleInputEmail1" className="form-label">COVID-19 Country</label>
                                    <input
